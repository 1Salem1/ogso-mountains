  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.container}>
        ...
        <Text style={styles.textHeader}> OGSO Europe Ltd. built the The Martian app as a Free app. This SERVICE is provided by OGSO Europe Ltd. at no cost and is intended for use as is.
