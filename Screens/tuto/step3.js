...
export default function Step3({ navigation }) {
  return (
    <View style={styles.container} >
      <ImageBackground source={require('../../assets/Backgrounds/onboarding-page2.png')} resizeMode="cover" style={styles.image}>
        ...
        style={{ "marginTop": -1, "color": "rgba(255, 255, 255, 1)", "fontSize": 35, "fontWeight": "400", "fontStyle": "normal", "fontFamily": "Esoris", "textAlign": "center", "lineHeight": 38.5 }}>
          <Text style={styles.TextOpacity}>{`AND`}</Text>
          {`\n SKI DIFFRENTLY`} !</Text></View>
        <View style={styles.containerDot}><Text style={styles.dot} > {'\u2B24'}   {'\u2B24'}   <Text style={{color : 'white'}}>{'\u2B24'}</Text></Text></View>
        <TouchableOpacity   onPress={()=> navigation.navigate('step4')}  style={{alignItems:'center',justifyContent:'center' , height : 1000} }>
