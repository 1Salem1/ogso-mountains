...
export default function Step1({ navigation }) {
  return (
    <View style={styles.container} >
      <ImageBackground source={require('../../assets/Backgrounds/layer1.png')} resizeMode="cover" style={styles.image}>
        ...
        style={{ "marginTop": -1, "color": "rgba(255, 255, 255, 1)", "fontSize": 35, "fontWeight": "400", "fontStyle": "normal", "fontFamily": "Esoris", "textAlign": "center", "lineHeight": 38.5 }}>
          <Text style={styles.TextOpacity}>{`LET'S START\n YOUR`}</Text>
          {`\n Expedition`} !</Text></View>
